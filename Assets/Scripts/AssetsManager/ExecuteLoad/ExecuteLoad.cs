    ...
    public abstract class UnityExecuteLoad : ExecuteLoadByLoadFile
    {
        ...
        protected IEnumerator LoadSceneAsync(AssetBundle bundle, string sceneName)
        {
            //if (bundle.isStreamedSceneAssetBundle)
            {
                ...
                string _sceneName = Global.UpperCaseFirstChar(sceneName);
                Debug.Log("场景名:" + _sceneName);
                ...
                while (asyncOperation.progress < 0.9f)
                {
                    ...
                    while (displayProgress < toProgress)
                    {
                        ...
                        //ManagerEvent.Call(ResloadMgr.MSG_ProgressBar, ManagerEvent.LOADSCENE, displayProgress, "正在加载资源……");
