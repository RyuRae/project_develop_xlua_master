    ...
    public class FileHelper : Singleton<FileHelper>
    {
        ...
        public static string GetFilePath(AssetRecord record, FileAddressType addressType)
        {
            ...
            else
            {
                ...
                //if (StrConst.IsNameByHash && record.Type != RuntimeAssetType.UNKNOW)
                //{
                //    fileName = addressType == FileAddressType.DOWNLOAD_TEMP ?
                //                  record.MD5Value + record.Version.ToString() :
                //                  record.MD5Value;
                //}
                //else
                {
        ...
        //public static bool SaveZip(string ZipID, byte[] ZipByte, string password = null)
        //{
        //    bool result = true;
        //    FileStream fs = null;
