...
namespace FileTools
{
    public class AssetRecordsInfo : AssetRecord
    {
        ...
        /// 是否通过hash值设置打包名称
        /// </summary>
        //public bool IsNameByHash = false;
        ...
        public AssetRecordsInfo() : base()
        {
            ...
            _OrigExt = (byte)FileExtension.CON;
        ...
        public AssetRecord GetAssetRecord(RuntimeAssetType type, string indexName)
        {
            ...
            string keyName = indexName.ToLower();
            if (recordDic != null && recordDic.ContainsKey(keyName))
            {
                return recordDic[keyName];
            }
            else
            {
                return null;
